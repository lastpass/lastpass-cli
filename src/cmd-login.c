...
int cmd_login(int argc, char **argv)
{
	...
	if (!force && plaintext_key && !ask_yes_no(false, "You have used the --plaintext-key option. This option will greatly reduce the security of your passwords. You are advised, instead, to use the agent, whose timeout can be disabled by settting LASTPASS_AGENT_TIMEOUT=0. Are you sure you would like to do this?"))
